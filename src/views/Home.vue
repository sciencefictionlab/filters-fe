<template>
  <div>
    ...
    <section class="section has-text-centered">
      <h1 class="title is-size-3 has-text-centered mt-5">This is a filter app.</h1>
      ...
      <div class="box mt-5" v-if="converted_image_url">
        ...
        <img v-bind:src="converted_image_url" alt=""
             style="width: 20rem; height:20rem">

        <br><br>
        <a v-bind:href="converted_image_url" target="_blank" class="button is-primary is-centered">
...
export default {
  ...
  methods: {
    ...
    uploadFileAndSend() {
      ...
      _axios.post(process.env.VUE_APP_API_URL + "/image/upload", formData, {
